# =============================================================================
# run_fwd_thesis.do  —  Thesis Section 5.3.1 → Hình 5.5
# Usage: cd ~/workspace/project2_axi/sim && vsim -do ../verify4thesis/logs/scripts/run_fwd_thesis.do
# =============================================================================
...
# Wave
 do /home/key/workspace/project2_axi/verify4thesis/tb/fwd/wave_fwd_thesis.do

run -all

coverage save -onexit ${OUT_DIR}/cov_fwd.ucdb
