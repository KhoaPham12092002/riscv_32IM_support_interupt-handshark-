...
# 2. TEST CONFIG
set TB_TOP    "tb_top"
set TB_FILE   "tb_csrpc.sv" 
# Tên test trong file tb_csrpc.sv
set TEST_NAME "riscv_stress_test" 
...
# =============================================================================
# GROUP 1: PERFORMANCE METRICS (MỚI THÊM)
# =============================================================================
add wave -noupdate -divider {PERFORMANCE METRICS}
add wave -noupdate -group "Perf Monitor" \
    -color "Green"  -label "Instr Retired"  /tb_top/vif/wb_valid_retire \
    -color "Red"    -label "Stall Cycles"   /tb_top/vif/pipeline_stall \
    -color "Orange" -label "Flush Cycles"   /tb_top/vif/pipeline_flush \
    -color "Yellow" -label "M-Unit Busy"    /tb_top/vif/m_unit_busy

# =============================================================================
# GROUP 2: HAZARD & FORWARDING
# =============================================================================
...
# =============================================================================
# GROUP 3: PIPELINE FLOW (THEO DÕI LỆNH TRÔI)
# =============================================================================
add wave -noupdate -divider {PIPELINE STAGES}

# Stage 1: FETCH
add wave -noupdate -group "1. IF Stage" \
    -label "PC Current"     /tb_top/dut/u_pc_gen/pc_o \
...
add wave -noupdate -group "2. ID Stage" \
    ...
    -label "CSR Req"        /tb_top/dut/u_decoder/ctrl_o.csr_req.valid

# Stage 3: EXECUTE
add wave -noupdate -group "3. EX Stage" \
    -label "PC EX"          /tb_top/dut/id_ex_out.pc \
    -color "Cyan" -label "ALU OpA" /tb_top/dut/u_alu/alu_in.a \
    -color "Cyan" -label "ALU OpB" /tb_top/dut/u_alu/alu_in.b \
    -label "ALU Res"        /tb_top/dut/u_alu/alu_o \
    -label "M Res"          /tb_top/dut/u_m_unit/result_o \
    -label "Branch Taken"   /tb_top/dut/branch_taken \
    -label "Trap Trig"      /tb_top/dut/trap_triggered
...
# =============================================================================
# GROUP 4: INTERFACES & REG FILE
# =============================================================================
add wave -noupdate -divider {SYSTEM STATE}

add wave -noupdate -group "IMEM Handshake" \
    -label "Req Valid" /tb_top/vif/imem_valid_req \
    -label "Req Ready" /tb_top/vif/imem_ready_rsp \
    -label "Resp Valid" /tb_top/vif/imem_valid_rsp

add wave -noupdate -group "DMEM Handshake" \
    -label "Req Valid" /tb_top/vif/dmem_valid_req \
    -label "Req Ready" /tb_top/vif/dmem_ready_rsp \
    -label "Resp Valid" /tb_top/vif/dmem_valid_rsp
...
add wave -noupdate -group "Registers (x1-x10)" \
    ...
    -label "x10 (a0)" /tb_top/dut/u_reg_file/rf[10]
